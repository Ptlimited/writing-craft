...
<p align="center">
  ...
  These nine came out of a <b>blind test</b> of 50 samples, scored by 3 AI judges who had no idea who wrote what. Then they were measured in a <b>second blind test</b>.<br>
  <br>
...
<p align="center">
  <a href="https://www.youtube.com/watch?v=09SRS0q4eFs">&#9654;&nbsp; Watch the blind test on YouTube</a>
</p>

---

Five models were given the same five everyday writing jobs, twice each. 50 outputs. Filenames scrambled, punctuation stripped, the answer key locked until every score was in. Three judges then scored all fifty blind and were each asked one open question, in their own words, with no vocabulary supplied: **what separated the high scorers from the low ones?**
...
Exit code is `0` when every mechanical check passes and `1` when any fails, so it drops into a pre-commit hook or CI.

This page fails its own hedge check, and that is the check working. A page teaching the hedge rule has to print the words it warns about, and the counter counts every one of them. Those are the defended kind. Everything else clears: contractions, rhythm, and no dashes. Run it yourself instead of trusting a number typed here, which is the whole point of shipping the script.
...
Every number below comes from one run, filmed end to end: [The Best AI for Creative Writing](https://www.youtube.com/watch?v=09SRS0q4eFs).
...
**3 judges, 2 labs, every one of them scoring blind.**
...
### The numbers behind the 3 checks
